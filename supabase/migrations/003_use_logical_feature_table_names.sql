...
begin
  ...
  if to_regclass('public.fantasy_items') is not null and to_regclass('public.private_zone_fantasies') is null then alter table public.fantasy_items rename to private_zone_fantasies; end if;
  ...
  if to_regclass('public.private_settings') is not null and to_regclass('public.private_zone_settings') is null then alter table public.private_settings rename to private_zone_settings; end if;
end $$;
